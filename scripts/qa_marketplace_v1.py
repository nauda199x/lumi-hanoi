...
assert 'name="sort"' in sale and 'name="sort"' not in rent, "Sale inventory exposes buyer sorting; rental keeps its existing ranking"
assert all('marketplace-list.js?v=20260905-inventory2' in page for page in (sale,rent)), "Marketplace hubs must use the current list script cache key"
