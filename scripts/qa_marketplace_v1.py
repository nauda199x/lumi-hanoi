...
assert all('name="sort"' in page and 'data-inventory' in page for page in (sale, rent)), "Both inventory hubs expose server-side sorting"
assert all('marketplace-list.js?v=20260905-discovery2' in page for page in (sale,rent)), "Marketplace hubs must use the current list script cache key"
...
assert 'site.css?v=20260907-performance1' in home, "Homepage must bust the stale hero stylesheet cache"
