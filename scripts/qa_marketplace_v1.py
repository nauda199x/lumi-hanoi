...
assert 'marketplace-mobile-controls' in list_js and 'marketplace-filter-backdrop' in list_js, "Mobile list needs compact filter/sort controls and bottom sheet"
...
assert all('name="area"' in page and 'name="sort"' in page for page in (sale,rent)), "Sale and rent filters need area and sorting controls"
assert all('20260829-market2' in page for page in (sale,rent)), "Marketplace hubs must bust stale list assets"
