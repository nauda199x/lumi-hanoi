...
create table if not exists public.listings (
  ...
  check (
    (phase = 'Signature' and tower in ('S1','S2','S3','S5','S6')) or
    (phase = 'Prestige' and tower in ('P1','P2')) or
...
check (unit_type in ('1PN','2PN','3PN','4PN','Duplex','Penthouse','Shop chân đế')) not valid;
